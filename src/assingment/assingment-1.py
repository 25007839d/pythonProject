...
# a = int(input("plz check input number"))
# b= str(a)
# add = 0
#
# for i in b:
...
# a = int(input("input the number to check prime number"))
#
# i=2
# pno=0
# nopno=0
...
#
# if nopno==1:
#     print(a,"it is not a prime no.")
#
# else:
#     print(a,"it is prome no")
...
#
#     if a==num:
#         print(num, "is a prime fibonaci number")
#         break
#     elif a>num:
#         break
#     else:
#         continue
# if a!=num:
#    print(num,"it is not a fibonaci number")
#
# i = 132
# a=0
# b=1
